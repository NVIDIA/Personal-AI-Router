...
func TestHandleHTTP_InferenceRouting(t *testing.T) {
	...
	test("native Ollama generate", "/api/generate")
	test("native Ollama chat", "/api/chat")
	test("native Ollama embeddings", "/api/embeddings")
	test("native Ollama embed", "/api/embed")
