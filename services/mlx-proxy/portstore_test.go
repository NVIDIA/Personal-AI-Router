...
func TestDefaultProxyPort(t *testing.T) {
	if defaultProxyPort != 8080 {
		t.Fatalf("default proxy port = %d, want 8080", defaultProxyPort)
	}
}
...
func TestChooseStartupPort(t *testing.T) {
	for _, tc := range []struct {
		...
		{"new default", 8080, 0, false, false, 8080},
		{"engine port never restored", 8080, 8081, false, true, 8080},
		{"custom survives opt-out", 8080, 12400, false, true, 12400},
		{"managed flag wins", 8080, 12400, true, true, 8080},
	} {
