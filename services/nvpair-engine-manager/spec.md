...
| `engine:remote-cancel-pull` | `{ node, engine, model }` | the remote cancellation result |
...
```json
{"jsonrpc":"2.0","method":"engine:pull-progress","params":{"engine":"ollama","model":"llama3.2","op":"pull","stage":"pulling","percent":62,"message":"pulling"}}
```
