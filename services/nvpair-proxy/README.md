...
| Inference routes | `/api/generate`, `/api/chat`, `/api/embeddings`, `/api/embed`, plus the OpenAI set and `/v1/messages` | `/v1/chat/completions`, `/v1/completions`, `/v1/embeddings`, `/v1/messages` |
