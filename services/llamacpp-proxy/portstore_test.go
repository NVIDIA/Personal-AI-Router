...
func TestDefaultProxyPort(t *testing.T) {
	if defaultProxyPort != 8084 {
		t.Fatalf("default proxy port = %d, want 8084", defaultProxyPort)
	}
}
...
func TestChooseStartupPort(t *testing.T) {
	for _, tc := range []struct {
		...
		{"new default", 8084, 0, false, false, 8084},
		{"persisted wins", 8084, 18084, false, true, 18084},
		{"custom survives opt-out", 8084, 12400, false, true, 12400},
		{"managed flag wins", 8084, 12400, true, true, 8084},
	} {
