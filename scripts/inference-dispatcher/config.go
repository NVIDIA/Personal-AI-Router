...
const (
	...
	// llama.cpp's stock listener is :8082; PAIR's llamacpp-proxy facade
	// claims :8084 (services/llamacpp-proxy/portstore.go defaultProxyPort).
	// Defaulting to the engine would bypass routing, same as LM Studio.
	defaultLlamaCppPort = 8084
